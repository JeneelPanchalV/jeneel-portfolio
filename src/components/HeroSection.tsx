    ...
    >
      ...
      >
        {[
          ...
          { label: 'Contact', href: 'mailto:jeneelpanchal74@gmail.com' },
        ].map(({ label, href }) => (
          <a
            key={label}
            href={href}
      ...
      <div className="overflow-hidden mt-6 sm:mt-4 md:-mt-5">
        <FadeIn delay={0.15} y={40}>
          <h1 className="hero-heading font-black uppercase tracking-tight leading-none whitespace-nowrap w-full text-[12vw] sm:text-[13vw] md:text-[13.5vw] lg:text-[14.5vw]">
            Hi, i&apos;m jeneel
          </h1>
        </FadeIn>
      </div>
      ...
      <div className="mt-auto flex justify-between items-end px-6 md:px-10 pb-7 sm:pb-8 md:pb-10 relative z-20">
        <FadeIn delay={0.35} y={20}>
          ...
          >
            an ai engineer building production systems where models meet interfaces
          </p>
        </FadeIn>
